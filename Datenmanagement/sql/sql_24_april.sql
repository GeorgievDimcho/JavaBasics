...
alter table rechnung add constraint fk_mit foreign key (mit_id) references mitarbeiter (mitarbeiterNum);
alter table rechnung add constraint fk_kunde foreign key (kunden_id) references kunden (kundennummer);
